          ...
          <div class="py-4 text-left">
            ...
            <p class="mt-2 p">
              ...
              <span
                ...
                :key="tech" 
                class="inline-flex items-center rounded-md bg-sky-400/10 hover:bg-sky-400/20 px-2 py-1 mr-1 text-xs leading-5 font-medium text-[#38bdf8] ring-1 ring-inset ring-blue-700/10"
              >
                {{ tech }}
              </span>
            </p>
